<template>
    ...
    :class="addClass"
        class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-bold rounded-lg text-sm h-12 w-full flex items-center justify-center text-xl font-bold"
    >
{{ title }}
    </button>
    <PopUpLauout
